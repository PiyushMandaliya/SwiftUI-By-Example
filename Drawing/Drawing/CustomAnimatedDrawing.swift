...
class Storm: ObservableObject {
    ...
    func update(to date: Date) {
        ...
        drops.insert(Raindrop(x: Double.random(in: 0...1), removalDate: date + 1, speed: Double.random(in: 0...1)))
    }
}

struct CustomAnimatedDrawing: View {
